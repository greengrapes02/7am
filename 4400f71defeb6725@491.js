...
function _billboard(__query,FileAttachment,invalidation){return(
__query(FileAttachment("billboard.csv"),{from:{table:"billboard"},sort:[],slice:{to:null,from:null},filter:[],select:{columns:null}},invalidation)
)}

async function _data(d3,FileAttachment){return(
d3.csv(await FileAttachment("billboard.csv").url())
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["billboard.csv", {url: new URL("./files/2bd57e7392fa08884d465a46ab21704a61f1620fd0cd22d240510f2e236315003ca1b3bfc8aec984b0c0290aad9a7a586e5115e9d7bd9c13627c0085a71cb73f.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], _1);
  main.variable(observer("billboard")).define("billboard", ["__query","FileAttachment","invalidation"], _billboard);
